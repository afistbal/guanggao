    ...
    <form action="<?php echo url("affiliate/account.edit_post")?>" method="POST" class="form-horizontal editAccount" id="form_b" >
      <div class="box-content">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="tel" id="tel" class="input-27" value="<?php echo $u['bankbranch']?>">
          </div>
        </div>
        <div class="control-group">
          <label for="textfield" class="control-label">银行账号</label>
          <div class="controls">
            <input type="text" name="tel" id="tel" class="input-27" value="<?php echo $u['bankaccount']?>">
          </div>
        </div>
        <div class="control-group">
          <label for="textfield" class="control-label">收款人</label>
          <div class="controls">
            <input type="text" name="tel" id="tel" class="input-27" value="<?php echo $u['accountname']?>">
          </div>
        </div>
