...
<div id="left">
  <div class="subnav">
    ...
    <ul class="subnav-menu">
      <li <?php if(get('get_plantype')=='') echo "class='current'"?>> <a href="<?php echo url("affiliate/zone.get_list")?>">所有活动</a> </li>
      <?php foreach((array)$plantype as $p) {?>
      <li <?php if(get('get_plantype')==$p['plantype']) echo "class='current'"?>> <a href="<?php echo url("affiliate/zone.get_list?get_plantype=".$p['plantype'])?>"><?php echo strtoupper($p['plantype'])?> 广告位</a> </li>
      <?php }?>
    </ul>
  </div>
  <div class="subnav">
