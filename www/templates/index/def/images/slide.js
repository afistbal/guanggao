(function($) {
	$.fn.slide = function(options) {
		...
		$("<ul style='width:" + ($(settings.slideContainer).length * 25 + ($(settings.slideContainer).length - 1) * 3) + "px;margin-left:-" + ($(settings.slideContainer).length * 12 + (($(settings.slideContainer).length - 1) * 3)) / 2 + "px' class='navListBox'>" + navlist + "</ul>").appendTo(el.parent());
